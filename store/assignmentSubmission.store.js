...
const storage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, "public/uploads/submissions/assignments");
  },
...
const AssignmentSubmissionUpload = multer({ storage: storage }).single("file");

module.exports = AssignmentSubmissionUpload;
